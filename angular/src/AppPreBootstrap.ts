...
export class AppPreBootstrap {
    ...
    private static getApplicationConfig(
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            AppConsts.isUseRemoteSignIn = result.isUseRemoteSignIn;
            AppConsts.remoteSignInUrl = result.remoteSignInUrl;
            AppConsts.remoteSignOutUrl = result.remoteSignOutUrl;
            AppConsts.erpUrl = result.erpUrl;
            AppConsts.remoteSignIn_AppId = result.remoteSignIn_AppId;
            AppConsts.remoteSignIn_AppSecret = result.remoteSignIn_AppSecret;
