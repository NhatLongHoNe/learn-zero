...
import {LoginInternalComponent} from "@account/login/login.internal.component";
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'admin-login', component: LoginInternalComponent, canActivate: [AccountRouteGuard] },
