...
using Asd.AbpZeroTemplate.Net.Sms;
using Asd.AbpZeroTemplate.Notifications;
using Asd.AbpZeroTemplate.Web.Models.Account;
using Asd.AbpZeroTemplate.Security;
using Asd.AbpZeroTemplate.Security.Recaptcha;
using Asd.AbpZeroTemplate.Sessions;
using Asd.AbpZeroTemplate.Url;
using Asd.AbpZeroTemplate.Web.Authentication.External;
using Asd.AbpZeroTemplate.Web.Security.Recaptcha;
using Asd.AbpZeroTemplate.Web.Session;
using Asd.AbpZeroTemplate.Web.Views.Shared.Components.TenantChange;
...
namespace Asd.AbpZeroTemplate.Web.Controllers
{
    public class AccountController : AbpZeroTemplateControllerBase
    {
        ...
        {
            return Url.Action("Index", "Home", new { area = "Accounting" });
        }
