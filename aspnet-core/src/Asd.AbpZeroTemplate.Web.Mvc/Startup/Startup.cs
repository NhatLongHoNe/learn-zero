...
using Asd.AbpZeroTemplate.Schemas;
using Asd.AbpZeroTemplate.Web.Chat.SignalR;
using Asd.AbpZeroTemplate.Web.Common;
using Asd.AbpZeroTemplate.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Asd.AbpZeroTemplate.Web.IdentityServer;
using Asd.AbpZeroTemplate.Web.Swagger;
using Stripe;
...
using Asd.AbpZeroTemplate.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Asd.AbpZeroTemplate.Web.Startup
{
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Asd.AbpZeroTemplate.Web.wwwroot.swagger.ui.index.html");
