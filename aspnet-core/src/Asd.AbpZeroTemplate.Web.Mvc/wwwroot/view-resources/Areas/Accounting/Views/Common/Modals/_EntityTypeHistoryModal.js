(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'Accounting/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Common/Modals/_EntityTypeHistoryModal.js',
