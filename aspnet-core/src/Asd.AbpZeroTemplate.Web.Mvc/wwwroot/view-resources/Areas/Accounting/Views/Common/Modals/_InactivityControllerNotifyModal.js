(function () {
    ...
    app.modals.InactivityControllerNotifyModal.create = function () {
        var modal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Common/InactivityControllerNotifyModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Common/Modals/_InactivityControllerNotifyModal.js',
