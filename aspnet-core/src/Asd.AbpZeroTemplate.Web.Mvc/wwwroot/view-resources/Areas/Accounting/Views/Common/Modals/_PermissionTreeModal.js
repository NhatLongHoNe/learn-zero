(function () {
    ...
    app.modals.PermissionTreeModal.create = function (options) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Common/PermissionTreeModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Common/Modals/_PermissionTreeModal.js',
