$(function () {
    ...
    var _addWidgetModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Accounting/' + $('#DashboardName').val() + '/AddWidgetModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/CustomizableDashboard/_AddWidgetModal.js',
