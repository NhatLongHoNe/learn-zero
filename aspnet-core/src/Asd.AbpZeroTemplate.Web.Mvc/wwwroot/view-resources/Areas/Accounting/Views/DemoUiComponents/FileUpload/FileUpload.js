$(function () {
    ...
    var url = abp.appPath + 'Accounting/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        dropZone: $('#fileuploadForm'),
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'Accounting/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;
