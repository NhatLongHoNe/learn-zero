(function () {
    ...
    app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
