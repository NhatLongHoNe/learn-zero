(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/DynamicProperty/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/DynamicProperties/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDynamicPropertyModal',
            cssClass: 'scrollable-modal'
        });

        var _manageValuesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/DynamicProperty/ManageValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/_Bundles/dynamic-properties-manage-values.min.js',
