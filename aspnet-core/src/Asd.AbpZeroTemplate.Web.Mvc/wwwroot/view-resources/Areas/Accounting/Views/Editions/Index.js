(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Editions/_CreateModal.js',
            modalClass: 'CreateEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Editions/_EditModal.js',
            modalClass: 'EditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
