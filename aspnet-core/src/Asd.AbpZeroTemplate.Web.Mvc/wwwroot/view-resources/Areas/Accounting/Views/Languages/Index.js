(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Languages/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "Accounting/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
