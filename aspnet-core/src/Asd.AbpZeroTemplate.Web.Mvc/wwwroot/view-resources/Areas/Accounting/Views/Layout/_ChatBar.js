    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'Accounting/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'Accounting/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'Accounting/Chat/UploadFile';
