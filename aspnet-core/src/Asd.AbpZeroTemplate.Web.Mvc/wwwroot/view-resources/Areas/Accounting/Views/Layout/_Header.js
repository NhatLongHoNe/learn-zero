(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_UserDelegationsModal.js',
