(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var _addRoleModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/OrganizationUnits/AddRoleModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/OrganizationUnits/_AddRoleModal.js',
