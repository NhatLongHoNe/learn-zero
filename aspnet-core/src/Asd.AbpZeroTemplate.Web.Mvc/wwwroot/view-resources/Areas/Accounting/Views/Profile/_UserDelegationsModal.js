(function ($) {
    app.modals.UserDelegationsModal = function () {
        ...
        var _createNewUserDelegationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Profile/CreateNewUserDelegationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Profile/_CreateNewUserDelegationModal.js',
