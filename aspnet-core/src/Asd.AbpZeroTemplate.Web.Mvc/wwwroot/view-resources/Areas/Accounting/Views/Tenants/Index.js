(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Asd.AbpZeroTemplate.MultiTenancy.Tenant';
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "Accounting/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Accounting/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "Accounting/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Accounting/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "Accounting/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Accounting/Views/Tenants/_FeaturesModal.js",
