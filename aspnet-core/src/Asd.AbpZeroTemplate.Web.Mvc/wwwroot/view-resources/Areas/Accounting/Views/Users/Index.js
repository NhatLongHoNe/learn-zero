(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Users/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Users/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditUserModal'
        });

        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/Users/_PermissionsModal.js',
            modalClass: 'UserPermissionsModal'
        });

        var _dynamicPropertiesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/_Bundles/manage-dynamic-entity-property-values-modal-min.js',
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicPropertiesModal.open({
                                    entityFullName: 'Asd.AbpZeroTemplate.Authorization.Users.User',
