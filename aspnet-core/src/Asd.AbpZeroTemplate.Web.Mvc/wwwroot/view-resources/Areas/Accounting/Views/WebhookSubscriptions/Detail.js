(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Accounting/WebhookSubscription/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Accounting/Views/WebhookSubscriptions/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        },
                        {
                            ...
                            action: function (data) {
                                window.location = "/Accounting/WebhookSubscription/WebhookEventDetail/" + data.record.webhookEventId;
                            }
                        }]
                    }
                },
